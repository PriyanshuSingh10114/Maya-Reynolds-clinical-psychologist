...
export default function OfficeSection() {
  ...
  return (
    <section
      id="office"
      className="py-[120px] bg-secondary border-t border-primary/10"
    >
      <div
        ref={ref}
        ...
        <div className="grid lg:grid-cols-2 gap-24 items-center">
          ...
          <div className="space-y-10 max-w-xl">
            <div className="space-y-4">
              <span className="text-accent text-[12px] tracking-[0.2em] uppercase font-semibold">
                Our Office
              </span>

              <h2 className="font-display text-[48px] md:text-[56px] leading-[1.1] text-primary">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-12 -left-12 w-[55%] aspect-square rounded-[2rem] overflow-hidden border border-primary/10 bg-secondary">
              <Image
                src="/office2.webp"
